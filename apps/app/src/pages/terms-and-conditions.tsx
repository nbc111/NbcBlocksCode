...
const TermsAndConditions = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>{t('Terms of Service | Nbcblocks')}</title>
      ...
      <div className="md:px-14 flex flex-col items-start md:py-16 -mt-80 mx-2">
        ...
        <div className="text-base text-neargray-600 dark:text-neargray-10 pt-12 pb-16 px-6 w-full bg-white dark:bg-black-600 lg:mt-8 flex flex-col gap-6 rounded-md">
          ...
          <p>
            ...
            our sole discretion, violates any NbcBlocks terms or policies.
          </p>
          ...
          <p>
            ...
            law, you grant NbcBlocks the rights we need to use your content
          ...
          <p>
            &quot;NbcBlocks&quot; the Company logo, and any other Company
