...
const AdvertisePage = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>{t('Advertise on nearblocks.io | Nbcblocks')}</title>
        ...
        <div className="w-full flex ">
          <div className="md:w-3/6 w-full flex flex-col items-start">
            ...
            <h3 className="text-neargray-600 md:w-3/4 w-full text-sm lg:!text-sm font-normal mt-3 dark:text-white text-justify">
              {t(
                'Nbcblocks is the leading Block Explorer, Search, API and Analytics Platform for the Nbc Blockchain.',
              )}
            </h3>
            <h3 className="text-neargray-600 md:w-3/4 w-full text-justify text-sm lg:!text-sm font-normal mt-3 dark:text-white break-words">
              {t(
                'Our website offers wide exposure to the Nbc Protocol and block chain community. Advertising with us makes it easier for users to discover your project through sponserd content on our web pages.',
              )}
            </h3>
            <Link
          ...
          <div className="w-full flex flex-row">
            <div className="w-full lg:w-1/2 p-4 flex flex-col items-center">
              <div className="flex flex-col sm:items-end w-fit justify-center">
                ...
                <span className="text-sm pt-1">Nbc Block Explorer</span>
              </div>
            </div>
            ...
            <div className="mt-8 grid lg:!grid-cols-9 grid-cols-1 lg:!gap-8">
              <div className="col-span-1 lg:!col-span-5 text-neargray-600 dark:text-neargray-10">
                ...
                <p className="text-xs lg:!text-base mt-3">
                  {t(
                    `Prominently create brand awareness and user retention with banner ads on Nbcblocks pages. Creatively promote, engage user and increase "eyeball" reach.`,
                  )}
                </p>
              ...
              <div className="col-span-1 lg:!col-span-5 text-neargray-600 dark:text-neargray-10">
                ...
                <p className="text-xs lg:!text-base mt-3">
                  {t(
                    ...
                    text displays in a non-intrusive and clean manner on the top of Nbcblocks pages.`,
                  )}
                </p>
                <div className="mt-5 font-normal gap-3 flex flex-col text-xs lg:!text-base">
                  <div className="flex items-center">
