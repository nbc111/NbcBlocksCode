            ...
            {row?.affected_account_id ? (
              ...
              >
                ...
                >
                  ...
                  >
                    {row?.affected_account_id?.includes('pex') 
  ? row.affected_account_id.replaceAll('pex', 'nbc') 
  : row.affected_account_id}
                  </Link>
                </span>
              </Tooltip>
              ...
              >
                ...
                >
                  <Link
                    ...
                    onMouseLeave={handleMouseLeave}
                  >
                    {row?.involved_account_id?.includes('pex') 
  ? row.involved_account_id.replaceAll('pex', 'nbc') 
  : row.involved_account_id}
                  </Link>
                </span>
              </Tooltip>
