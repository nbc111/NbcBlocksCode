...
const TpsChart = (props: Props) => {
  ...
  <html>
    ...
    <body >
      ...
      ${
        poweredBy
          ? '<p style="text-align: center; color: #000; font-size: 0.75rem; padding-top: 1rem; padding-bottom: 1rem; font-family: sans-serif;">Powered by <a href="https://nearblocks.io/?utm_source=bos_widget&utm_medium=Charts" target="_blank" style="font-weight: 600; font-family: sans-serif; color: #000; text-decoration: none;">NBCBlocks</a></p>'
          : ''
      }
            ...
            <div className="border-b dark:border-black-200 flex justify-between items-center text-center">
              {chartTpsData?.length > 0 ? (
                <>
                  ...
                  Nbc Transactions per Second Chart shows the transactions
                    occuring per second on Nbc blockchain.
                  </p>
