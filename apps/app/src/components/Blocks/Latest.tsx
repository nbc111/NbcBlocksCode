    ...
    <>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="col-span-2 md:col-span-1 px-2 order-2 md:order-1  text-sm whitespace-nowrap dark:text-green-250 truncate">
                      ...
                      >
                        {block?.author_account_id?.includes('pex') ? 'nbc' : block?.author_account_id}
                      </Link>
                      <div className="text-nearblue-700 text-sm ">
      ...
      {blocks && blocks?.length > 0 && (
        <div className="border-t dark:border-black-200 px-2 py-3 text-nearblue-600">
          <Link
            href="/blocks"
            className="block  dark:text-white text-center border border-green-900/10 bg-[#5698c3] dark:bg-black-600/[0.75] hover:bg-[#5698c3] font-thin dark:font-normal dark:hover:text-green-250 text-white dark:text-sm text-xs py-3 rounded w-full focus:outline-none hover:no-underline"
          >
            View all blocks
          </Link>
        </div>
