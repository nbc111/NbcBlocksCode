      ...
      cell: (row: TransactionInfo) => (
        <span>
          {row?.actions_agg?.deposit
            ? yoctoToPex(row?.actions_agg?.deposit, true)
            : row?.actions_agg?.deposit ?? ''}{' '}
          Ⓟ
        </span>
      ),
      ...
      cell: (row: TransactionInfo) => (
        <span>
          {row?.outcomes_agg?.transaction_fee
            ? yoctoToPex(row?.outcomes_agg?.transaction_fee, true)
            : row?.outcomes_agg?.transaction_fee ?? ''}{' '}
          Ⓟ
        </span>
      ),
      ...
      cell: (row: TransactionInfo) => (
        <span>
          ...
          >
            ...
            >
              <Link
                href={`/address/${row?.signer_account_id?.includes('pex')
                  ? row.signer_account_id.replace(/pex/g, 'nbc')
              ...
              >
                {row?.signer_account_id?.includes('pex')
                  ? row.signer_account_id.replace(/pex/g, 'nbc')
              : row?.signer_account_id}
              </Link>
            </span>
          ...
          >
            <span>
              <Link
                ...
                onMouseLeave={handleMouseLeave}
              >
                {row?.receiver_account_id?.includes('pex')
  ? row.receiver_account_id.replace(/pex/g, 'nbc')
