    ...
    >
        ...
        <TabPanel>
          ...
          {!schema && (
            <p className="text-xs mx-4 text-gray-500 mb-4 bg-gray-100 dark:bg-black-200 px-2 py-2  w-fit rounded shadow">
              {`NBC ABI schema not found, We have provide a best effort “auto detect” facility to find successful methods and parameters from past transactions. If you are the contract owner please consider recompiling your contract with NBC`}{' '}
              <a
      ...
      {schema && schema?.body?.functions.length > 0 && (
        <TabPanel>
          ...
          <p className="text-xs mx-4 text-gray-500 mb-4 bg-gray-100 dark:bg-black-200 px-2 py-2  w-fit rounded shadow">
            Methods and parameters are automatically shown from the embedded NBC{' '}
            <a
              className="text-green-500 dark:text-green-250"
              target="_blank"
              href="https://github.com/near/abi"
